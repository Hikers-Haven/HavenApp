...
class MapService {
  ...
  Future<List<LatLng>> fetchRoute(LatLng start, LatLng end,
    ...
    // Make sure to remove the last semicolon if waypoints are added
    String url =
        'https://api.mapbox.com/directions/v5/mapbox/cycling/${start.longitude},${start.latitude};${waypointsString}${end.longitude},${end.latitude}?geometries=geojson&overview=full&access_token=$accessToken';
